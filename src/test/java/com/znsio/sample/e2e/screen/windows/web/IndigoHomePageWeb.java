...
public class IndigoHomePageWeb extends IndigoHomeScreen {
    private static final Logger LOGGER = Logger.getLogger(IndigoHomePageWeb.class.getName());
    private final Driver driver;
    private final Visual visually;
    private final String SCREEN_NAME = IndigoHomePageWeb.class.getSimpleName();
    private static final By bybookMenuXpath = By.xpath("//a[@title = 'Book']");
    private static final By byGiftVoucherXpath = By.xpath("//a[@class='text-decoration-none']//div[text()='Gift Voucher']");
